  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-60 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        // Navy primary
        default:
          "bg-primary text-primary-foreground hover:bg-navy-600 shadow-sm hover:shadow-md",
        // Gold CTA
        gold: "bg-accent text-accent-foreground hover:bg-gold-600 shadow-sm hover:shadow-md",
        // Navy outline
        outline:
          "border-[1.5px] border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground",
        // Gold outline
        "outline-gold":
          "border-[1.5px] border-accent bg-transparent text-accent-foreground hover:bg-accent hover:text-accent-foreground",
        secondary:
